...
cut -f 1-52 train/genotypes/genos_ukb_l1e7_ss500_m0.08_${w}_chr1_20.rmdup.train.re.1M.pca.eigenvec | tail -n+2 - > re.tmp

#paste them together and add header
paste -d '\t' re.tmp cm.tmp >  cmre.noheader

cat cm.header cmre.noheader > train/genotypes/genos_ukb_l1e7_ss500_m0.08_${w}_chr1_20.rmdup.train.cmre.pca.eigenvec
