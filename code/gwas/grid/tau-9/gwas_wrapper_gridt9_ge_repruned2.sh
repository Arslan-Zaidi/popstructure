...
train/gwas_results/fixed_effects/ge/gwas_gridt9_train.ge.${rep}.repruned2 \
train/genotypes/genos_grid_d36_m0.07_s500_t9_chr1_20.rmdup.train.snps.repruned2.pca.eigenvec
