...
pop.test=fread(here("gwas/grid/genotypes/tau-9/ss500/genos_grid_d36_m0.07_s500_t9.test.pop"))
pop.test$FID=pop.test$IID=paste("tsk_",seq(1,17999,2),sep="")

prs1=fread(here(paste("gwas/grid/genotypes/tau-9/ss500/test/prs/gridt9_prs_",pheno,".all.c.sscore",sep="")))
prs2=fread(here(paste("gwas/grid/genotypes/tau-9/ss500/test/prs/gridt9_prs_",pheno,".all.c.p.sscore",sep="")))
prs3=fread(here(paste("gwas/grid/genotypes/tau-9/ss500/test/prs/gridt9_prs_",pheno,".all.nc.sscore",sep="")))
...
ggsave(here(paste("plots/prs/grid/tau-9/plt_prs_",pheno,".pdf",sep="")),
       plt_prs_phe,
       height=95,
       width=95,
       units="mm")
