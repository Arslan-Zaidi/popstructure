...
fsummarize=function(phenotype="smooth",correction="cm"){
  dat = fread(F(paste("gwas/grid/genotypes/tau-9/ss500/train/gwas_results/mlma/gridt9.",phenotype,".",correction,".mlma.gz",sep="")))
  colnames(dat)=
...
plt_combined.shp.gwtpcs=plt1+plt2

plt_combined.shp.gwtpcs
```
