...
fmake_plots= function(pheno,tau,plot_title){
  ...
  gvalue_df = fread(F(paste("gwas/grid/genotypes/tau",tau,"/ss500/test/gvalue/genos_grid_d36_m0.05_s500_t",tau,".rmdup.test.all.gvalue.sscore.gz",sep="")))
...
plts_smooth1 = fmake_plots("smooth",100,"Smooth(N-S)")
#plts_smooth2 = fmake_plots("smooth_long","Smooth(E-W")
plts_sharp = fmake_plots("sharp",100,"Sharp")
...
ggsave(here("plots/prs/complex_dem/plt_prs_gridt100_05182020.pdf"),
       combined_plt,
       height=135,
       width=110,
       units="mm")
