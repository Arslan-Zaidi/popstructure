...
pop.test=fread(F("gwas/ukb/popfiles/ukb_ss500_d35.weighted.pop"))
#pop.test$FID=pop.test$IID=paste("tsk_",seq(1,17999,2),sep="")

#load the genetic value
gvalue_df = fread(F("gwas/ukb/test/genos_ukb_l1e7_ss500_m0.08_weighted_chr1_20.rmdup.train.all.gvalue.sscore.gz"))
...
prs2=fread(F(paste("gwas/ukb/test/prs/ukbdem_prs_",pheno,".all.weighted.c.p.sscore.gz",sep="")))
prs3=fread(F(paste("gwas/ukb/test/prs/ukbdem_prs_",pheno,".all.weighted.nc.sscore.gz",sep="")))
...
ggsave(F("plots/prs/ukb/plt_prs_ukb_smooth.pdf"),
       plts_smooth1,
       height=110,
       width=55,
       units="mm")
...
ggsave(F("plots/prs/ukb/plt_prs_ukb_sharp.pdf"),
       plts_sharp1,
       height=110,
       width=55,
       units="mm")
