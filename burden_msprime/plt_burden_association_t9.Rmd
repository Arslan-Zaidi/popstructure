...
pburden1<-fread(F("burden_msprime2/association/bgwas_r0_t9_xall.txt.gz"))
pburden2<-fread(F("burden_msprime2/association/bgwas_r1_t9_x1_579.txt.gz"))
...
ggsave(F("plots/burden_msprime/plt_burden_association_07072020.pdf"),
       plts.combined,
       height=12,
       width=14,
       units="cm")
