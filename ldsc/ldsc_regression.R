...
out_prefix=args[3] #prefix of output file
}
...
freq100=fread(here("gwas/grid/genotypes/tau100/ss500/train/genos_grid_d36_m0.05_s500_t100.rmdup.train.frq.afreq"))
...
write_rds(plt,
	here(paste("gwas/grid/analysis/ldsc/",out_prefix,".rds",sep="")),compress="none")
