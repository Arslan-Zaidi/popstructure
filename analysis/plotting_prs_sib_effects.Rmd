---
title: "The effect of carrying out standard GWAS vs sib-based GWAS on polygenic score stratification"
...
Load genetic values for each individual. We need to subtract these out to look at the residual stratification in polygenic scores.
...
Load polygenic scores for smooth and sharp effect.
...
Load 'pop' file which contains info on each individual's x,y coordinates and add this info to the polygenic scores. Then subtract out genetic values and calculate the mean polygenic score per deme.
...
Plot polygenic scores for sharp effect.
