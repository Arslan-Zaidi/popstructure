...
#load genotypes
ht_sibs = np.load("genotypes/genos_gridt100_l1e7_ss750_m0.05_chr"
                    +args.chrom
                    +"_sibs_assort.haps.npz")

ht_sibs = allel.HaplotypeArray(ht_sibs['arr_0'])

#load genetic effect sizes simulated in the training dataset
legend = np.loadtxt("genotypes/genos_gridt100_l1e7_ss750_m0.05_chr"
                      +args.chrom
                      +"_sibs_assort.legend",
...
#load genetic effect sizes simulated in the training dataset
effects = pd.read_csv("../train/genotypes/genos_gridt100_l1e7_ss750_m0.05_chr1_20.rmdup.train."
                        +args.effect_i
...
pairs_np = np.loadtxt("mates/genos_gridt100_assort_1_4.sample",
                        skiprows=1,dtype="str")
...
np.savetxt("gvalues/genos_gridt100_l1e7_ss750_m0.05_chr"
            +args.chrom+"_e"
            + args.effect_i
            +"_sibs_assort.sscore",
           gsum,
